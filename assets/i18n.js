(function () {
  ...
  const t = {
    tr: {
      ...
      stat1: "Alan", stat2: "Pazar", stat3: "Platform", businessTitle: "NJ GROUP Ana Faaliyet Yapısı",
      ...
      enterPage: "Detay Sayfasına Gir", sliderHint: "Sağa sola kaydırarak NJ GROUP faaliyet yapısını gezebilirsiniz.",
    ...
    en: {
      ...
      stat1: "Areas", stat2: "Markets", stat3: "Platform", businessTitle: "NJ GROUP Core Business Areas",
      ...
      enterPage: "Open Detail Page", sliderHint: "Swipe left or right to explore the NJ GROUP business structure.",
    ...
    zh: {
      ...
      stat1: "板块", stat2: "市场", stat3: "平台", businessTitle: "NJ GROUP 核心业务板块",
      businessSub: "我们整合市场进入、渠道开发、数字营销、展厅管理、商务活动和本地运营服务，打造区域性工业合作平台。",
      enterPage: "进入详情页面", sliderHint: "左右滑动查看 NJ GROUP 核心业务结构。",
    ...
    fr: {
      ...
      stat1: "Domaines", stat2: "Marchés", stat3: "Plateforme", businessTitle: "Domaines d'activité NJ GROUP",
      ...
      enterPage: "Ouvrir la page détail", sliderHint: "Faites défiler horizontalement pour explorer la structure d'activité NJ GROUP.",
    ...
    de: {
      ...
      stat1: "Bereiche", stat2: "Märkte", stat3: "Plattform", businessTitle: "NJ GROUP Kerngeschäftsfelder",
      ...
      enterPage: "Detailseite öffnen", sliderHint: "Wischen Sie horizontal, um die NJ GROUP Geschäftsstruktur zu entdecken.",
