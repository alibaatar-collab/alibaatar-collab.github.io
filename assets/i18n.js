(function () {
  ...
  const t = {
    tr: {
      ...
      heroText: "NJ GROUP, Türkiye merkezli, Çin ile Avrupa pazarlarını birbirine bağlayan yerelleştirilmiş bir endüstriyel operasyon platformudur. Pazar geliştirme, kanal yönetimi, marka operasyonları ve yerel hizmet çözümleri sunuyoruz.",
      heroCta1: "Faaliyet Alanları", heroCta2: "İletişime Geç", panelTitle: "Stratejik Yapı",
      panelText: "Çin tedarik zinciri + Türkiye yerel operasyonu + Avrupa pazar bağlantıları.",
      stat1: "Alan", stat2: "Pazar", stat3: "Platform", businessTitle: "6 Ana Faaliyet Alanımız",
      ...
      enterPage: "Detay Sayfasına Gir", sliderHint: "Sağa sola kaydırarak 6 ana faaliyet alanını gezebilirsiniz.",
      alt: "Alt hizmetler", strengthsTitle: "Temel Güçlerimiz",
      strengthsSub: "NJ GROUP, Çin üretimini Türkiye operasyonları ve Avrupa pazarı ile birleştiren bölgesel bir ticari ekosistem oluşturmaktadır.",
      strengthCoreKicker: "NJ GROUP PLATFORM", strengthCoreTitle: "Çin - Türkiye - Avrupa arasında yerelleştirilmiş operasyon gücü",
      ...
      companyTitle: "NJ GROUP YEŞİL DÖNÜŞÜM TEKNOLOJİ",
      companyText: "NJ GROUP YEŞİL DÖNÜŞÜM TEKNOLOJİ SANAYİ VE DIŞ TİCARET LİMİTED ŞİRKETİ'nin merkezi İstanbul'daki İSTOÇ ticaret bölgesinde bulunmaktadır. Türkiye'nin stratejik konumu ve ticari avantajları sayesinde Çin tedarik zinciri entegrasyonu, Türkiye yerel kanal ağı, Avrupa pazar bağlantıları, dijital pazarlama sistemleri ve showroom hizmetleri sunuyoruz.",
      companyLine: "Biz sadece bir dış ticaret şirketi değiliz.", companyKicker: "NJ GROUP COMPANY PROFILE", companyVisualTitle: "EURASIA INDUSTRIAL PLATFORM", companyVisualText: "China supply chain, Türkiye local operation and European market connection.", companyCards: ["İstanbul merkezli yerel ticari operasyon", "Çin, Türkiye ve Avrupa arasında köprü", "Sanayi, teknoloji, dijital ve organizasyon çözümleri"], aboutTitle: "Hakkımızda",
      aboutText: "NJ GROUP'un temel amacı yalnızca ürün ithalatı ve ihracatı yapmak değildir. Ana hedefimiz, Çin üretiminin Türkiye ve Avrupa pazarlarında yerelleştirilmiş operasyon sistemini kurmaktır.",
    ...
    en: {
      ...
      heroText: "NJ GROUP is a Türkiye-based localized industrial operations platform connecting China with European markets. We provide market development, channel management, brand operations and local service solutions.",
      heroCta1: "Business Areas", heroCta2: "Contact Us", panelTitle: "Strategic Structure",
      panelText: "China supply chain + Türkiye local operations + European market connections.",
      stat1: "Areas", stat2: "Markets", stat3: "Platform", businessTitle: "Our 6 Core Business Areas",
      ...
      enterPage: "Open Detail Page", sliderHint: "Swipe left or right to explore the 6 core business areas.",
      alt: "Sub services", strengthsTitle: "Core Strengths",
      strengthsSub: "NJ GROUP creates a regional commercial ecosystem that connects Chinese manufacturing with Türkiye operations and the European market.",
      strengthCoreKicker: "NJ GROUP PLATFORM", strengthCoreTitle: "Localized operational power between China, Türkiye and Europe",
      ...
      companyTitle: "NJ GROUP GREEN TRANSFORMATION TECHNOLOGY",
      companyText: "NJ GROUP YEŞİL DÖNÜŞÜM TEKNOLOJİ SANAYİ VE DIŞ TİCARET LİMİTED ŞİRKETİ is headquartered in the İSTOÇ trade district of Istanbul. With Türkiye's strategic location and commercial advantages, we provide China supply chain integration, Türkiye local channels, European market connections, digital marketing systems and showroom services.",
      companyLine: "We are more than a foreign trade company.", companyKicker: "NJ GROUP COMPANY PROFILE", companyVisualTitle: "EURASIA INDUSTRIAL PLATFORM", companyVisualText: "China supply chain, Türkiye local operation and European market connection.", companyCards: ["Istanbul-based local commercial operation", "A bridge between China, Türkiye and Europe", "Industrial, technology, digital and event solutions"], aboutTitle: "About Us",
      aboutText: "NJ GROUP's purpose is not limited to product import and export. Our main goal is to establish a localized operating system for Chinese manufacturing in Türkiye and European markets.",
    ...
    zh: {
      ...
      heroText: "NJ GROUP 是一家位于土耳其的本地化工业运营平台，连接中国与欧洲市场，提供市场开发、渠道管理、品牌运营和本地服务解决方案。",
      heroCta1: "业务板块", heroCta2: "联系我们", panelTitle: "战略结构",
      panelText: "中国供应链 + 土耳其本地运营 + 欧洲市场连接。",
      stat1: "板块", stat2: "市场", stat3: "平台", businessTitle: "六大核心业务板块",
      businessSub: "我们整合市场进入、渠道开发、数字营销、展厅管理、商务活动和本地运营服务，打造区域性工业合作平台。",
      enterPage: "进入详情页面", sliderHint: "左右滑动查看 6 个核心业务板块。",
      alt: "查看细分业务", strengthsTitle: "核心优势",
      strengthsSub: "NJ GROUP 将中国制造、土耳其本地运营和欧洲市场连接起来，形成区域化商业生态。",
      strengthCoreKicker: "NJ GROUP 平台", strengthCoreTitle: "连接中国、土耳其与欧洲的本地化运营能力",
      strengthCoreText: "我们把供应链、市场进入、数字销售、展厅、展会和售后支持整合在同一个平台中。",
      companyTitle: "NJ GROUP 绿色转型科技",
      companyText: "NJ GROUP YEŞİL DÖNÜŞÜM TEKNOLOJİ SANAYİ VE DIŞ TİCARET LİMİTED ŞİRKETİ 总部位于伊斯坦布尔 İSTOÇ 商贸区。依托土耳其的战略位置和商业优势，我们提供中国供应链整合、土耳其本地渠道、欧洲市场连接、数字营销系统和展厅服务。",
      companyLine: "我们不只是一家外贸公司。", companyKicker: "NJ GROUP 公司介绍", companyVisualTitle: "欧亚工业平台", companyVisualText: "中国供应链、土耳其本地运营与欧洲市场连接。", companyCards: ["伊斯坦布尔本地商务运营", "连接中国、土耳其与欧洲", "工业、科技、数字与组织服务"], aboutTitle: "关于我们",
      aboutText: "NJ GROUP 的目标不只是产品进出口。我们的核心目标是在土耳其和欧洲市场建立中国制造的本地化运营体系。",
      visionTitle: "愿景与使命",
    ...
    fr: {
      ...
      heroText: "NJ GROUP est une plateforme d'opérations industrielles localisée en Türkiye, reliant la Chine aux marchés européens. Nous proposons développement de marché, gestion des canaux, opérations de marque et services locaux.",
      heroCta1: "Domaines d'activité", heroCta2: "Nous contacter", panelTitle: "Structure stratégique",
      panelText: "Chaîne d'approvisionnement chinoise + opérations locales en Türkiye + connexions européennes.",
      stat1: "Domaines", stat2: "Marchés", stat3: "Plateforme", businessTitle: "Nos 6 domaines d'activité",
      ...
      enterPage: "Ouvrir la page détail", sliderHint: "Faites défiler horizontalement pour explorer les 6 domaines.",
      alt: "Services détaillés", strengthsTitle: "Forces principales",
      strengthsSub: "NJ GROUP crée un écosystème commercial régional reliant la production chinoise, les opérations en Türkiye et le marché européen.",
      strengthCoreKicker: "PLATEFORME NJ GROUP", strengthCoreTitle: "Puissance opérationnelle localisée entre Chine, Türkiye et Europe",
      ...
      companyTitle: "NJ GROUP TECHNOLOGIE DE TRANSFORMATION VERTE",
      companyText: "NJ GROUP YEŞİL DÖNÜŞÜM TEKNOLOJİ SANAYİ VE DIŞ TİCARET LİMİTED ŞİRKETİ est basée dans la zone commerciale İSTOÇ à Istanbul. Grâce à la position stratégique de la Türkiye, nous fournissons intégration de chaîne d'approvisionnement chinoise, canaux locaux, connexions européennes, systèmes de marketing digital et services showroom.",
      companyLine: "Nous sommes plus qu'une société de commerce extérieur.", companyKicker: "PROFIL DE NJ GROUP", companyVisualTitle: "PLATEFORME INDUSTRIELLE EURASIE", companyVisualText: "Chaîne d'approvisionnement chinoise, opérations locales en Türkiye et connexion européenne.", companyCards: ["Opération locale basée à Istanbul", "Pont entre Chine, Türkiye et Europe", "Solutions industrielles, technologiques, digitales et événementielles"], aboutTitle: "À propos",
      aboutText: "L'objectif de NJ GROUP ne se limite pas à l'import-export. Notre but principal est de créer un système d'opérations localisées pour la production chinoise en Türkiye et en Europe.",
    ...
    de: {
      ...
      heroText: "NJ GROUP ist eine in der Türkiye ansässige lokalisierte Industrieplattform, die China mit europäischen Märkten verbindet. Wir bieten Marktentwicklung, Kanalmanagement, Markenbetrieb und lokale Servicelösungen.",
      heroCta1: "Geschäftsfelder", heroCta2: "Kontakt", panelTitle: "Strategische Struktur",
      panelText: "Chinesische Lieferkette + lokale Operationen in Türkiye + europäische Marktverbindungen.",
      stat1: "Bereiche", stat2: "Märkte", stat3: "Plattform", businessTitle: "Unsere 6 Kerngeschäftsfelder",
      ...
      enterPage: "Detailseite öffnen", sliderHint: "Wischen Sie horizontal, um die 6 Geschäftsfelder zu entdecken.",
      alt: "Unterservices", strengthsTitle: "Kernstärken",
      strengthsSub: "NJ GROUP schafft ein regionales Handelsökosystem, das chinesische Produktion mit Operationen in Türkiye und dem europäischen Markt verbindet.",
      strengthCoreKicker: "NJ GROUP PLATTFORM", strengthCoreTitle: "Lokalisierte Betriebskraft zwischen China, Türkiye und Europa",
      ...
      companyTitle: "NJ GROUP TECHNOLOGIE FÜR GRÜNE TRANSFORMATION",
      companyText: "NJ GROUP YEŞİL DÖNÜŞÜM TEKNOLOJİ SANAYİ VE DIŞ TİCARET LİMİTED ŞİRKETİ hat seinen Sitz im İSTOÇ-Handelsgebiet in Istanbul. Dank der strategischen Lage der Türkiye bieten wir Integration chinesischer Lieferketten, lokale Kanäle, europäische Marktverbindungen, digitale Marketingsysteme und Showroom-Services.",
      companyLine: "Wir sind mehr als ein Außenhandelsunternehmen.", companyKicker: "NJ GROUP UNTERNEHMENSPROFIL", companyVisualTitle: "EURASISCHE INDUSTRIEPLATTFORM", companyVisualText: "Chinesische Lieferkette, lokale Operationen in Türkiye und europäische Marktverbindung.", companyCards: ["Lokaler Geschäftsbetrieb in Istanbul", "Brücke zwischen China, Türkiye und Europa", "Industrie-, Technologie-, Digital- und Eventlösungen"], aboutTitle: "Über uns",
      aboutText: "Das Ziel von NJ GROUP ist nicht nur Import und Export. Unser Hauptziel ist der Aufbau eines lokalisierten Betriebssystems für chinesische Produktion in Türkiye und Europa.",
