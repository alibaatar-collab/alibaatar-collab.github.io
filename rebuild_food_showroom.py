...
<head>
  ...
  <style>
    ...
    * {{ box-sizing:border-box; }}
    ...
    .brand img {{ width:94px; height:54px; object-fit:contain; border-radius:6px; background:#fff; padding:4px; }}
  ...
  <header>
    <div class="wrap head">
      <a class="brand" href="index.html">
        <img src="assets/nj-group-official-logo.jpg" alt="NJ GROUP">
